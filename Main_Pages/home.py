...
def show():
    ...
    st.image("images/shinchan2.jpg", width=100)
    ...
    if features == "Conversational ChatBot":
        ...
        st.image('images/Code.png', use_column_width=True)
        st.markdown('''
        ...
        ''')
    elif features == "Image Description":
        ...
        - **Description2:** You can generate Captions for social media posts
        ...
        st.image('images/Video.png', use_column_width=True)
        st.markdown('''
        ...
        st.image('images/Document.png', use_column_width=True)
        st.markdown('''
        ...
        st.image('images/Blog.png', use_column_width=True)
        st.markdown('''
